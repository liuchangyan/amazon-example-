...
wget https://aws-solutions-assets.s3.cn-north-1.amazonaws.com.cn/aws-cli/awscli-bundle.zip | tee -a ${HANA_LOG_FILE}
...
wget https://aws-solutions-assets.s3.cn-north-1.amazonaws.com.cn/GitHub/stedolan/jq/releases/download/jq-1.5/jq-linux64 -O jq
